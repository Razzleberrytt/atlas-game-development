...
| P9 — Special enemy and boss | In progress | `P9-PLAN-001` through `P9-0103` complete: the Blight Spitter is a live `EnemyDirectorService` archetype, and The Progenitor boss's contracts, configuration, and pure phase resolver (monotonic Carapace → Brood → Collapse → Defeated, vulnerability windows, Slam AoE, Brood summon, shroud/darkness) are implemented and fixture-tested. The boss runtime (`P9-0104`) is next. |
