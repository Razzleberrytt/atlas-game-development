...
- **Blocked on evidence or dependencies:** no implementable RPG task remains. `RPG-0108`'s "three viable build patterns" gate, `RPG-0113`'s validation matrix, and the HROI representative playtest still need Studio sessions; `RPG-0112` is now unblocked by P10's authoritative result owner. P7 class-effect runtime is now unblocked, while P8 and later still wait on their prerequisites.
