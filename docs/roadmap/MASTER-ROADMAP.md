...
| P9 — Special enemy and boss | In progress | `P9-PLAN-001` and `P9-0101` complete: the Blight Spitter special enemy and The Progenitor boss are specified, and the Spitter's contracts, configuration, and pure ability resolver are implemented and fixture-tested. `P9-0102` runtime integration is next. |
