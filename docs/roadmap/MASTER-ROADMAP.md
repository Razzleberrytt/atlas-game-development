...
| P9 — Special enemy and boss | In progress | `P9-PLAN-001` through `P9-0104` complete: the Blight Spitter and The Progenitor boss are both live `EnemyDirectorService` archetypes. The boss anchors the extraction holdout with monotonic phases, vulnerability-gated damage, the Slam AoE, the Brood add surge, and the shroud/darkness visibility override wired into combat. Readable telegraphs (`P9-0105`) and encounter validation (`P9-0106`) remain. |
