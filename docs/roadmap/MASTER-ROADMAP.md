...
| P9 — Special enemy and boss | In progress | `P9-PLAN-001`, `P9-0101`, and `P9-0102` complete: the Blight Spitter special enemy is specified, implemented as a pure resolver, and integrated as a live archetype in `EnemyDirectorService` (Corrosive Bloom charge/commit/lingering pool through the P3 boundary). Boss contracts/runtime (`P9-0103`+) are next. |
