...
| P9 — Special enemy and boss | In progress | `P9-PLAN-001` through `P9-0105` complete: the Blight Spitter and The Progenitor boss are live `EnemyDirectorService` archetypes with readable client telegraphs (bloom/Slam ground discs, lingering footprint, boss phase/exposed status). Only `P9-0106` (encounter security, performance, and class-composition validation) remains to close P9. |
