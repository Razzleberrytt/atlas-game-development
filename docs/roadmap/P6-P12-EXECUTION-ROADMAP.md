...
P7 is **complete** (`P7-PLAN-001` through `P7-0107`). P8 is implemented through `P8-0107` (see [`../specifications/authored-objective-chain.md`](../specifications/authored-objective-chain.md)); `P8-0108` automated coverage is complete and only its live Studio playtest remains. `P9-PLAN-001` through `P9-0103` are **complete** (see [`../specifications/special-enemy-and-boss-encounter.md`](../specifications/special-enemy-and-boss-encounter.md); the Blight Spitter is a live director archetype and The Progenitor boss's contracts/config/phase resolver are implemented); the next unblocked gameplay task is `P9-0104` (the boss runtime and authored-arena integration).
...
- [ ] **P9-0104 — Implement the boss runtime and authored arena integration.**
...
- [ ] **P9-0105 — Add readable telegraphs and accessible presentation.**
...
1. Schedule the **P8-0108** live Studio playtest of the full objective chain (forced relocation and temporary defense). P8 is implemented and fixture-validated through `P8-0107`. **P9-PLAN-001** through **P9-0103** are complete (see [`../specifications/special-enemy-and-boss-encounter.md`](../specifications/special-enemy-and-boss-encounter.md); the Blight Spitter is a live `EnemyDirectorService` archetype and The Progenitor boss's contracts/config/phase resolver are implemented); begin **P9-0104** (the boss runtime and authored-arena integration).
