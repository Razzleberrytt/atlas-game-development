...
1. **BA-011 — Main World source representation/placement strategy.** Define the authored-overworld lifecycle/root/place boundary, reviewable representations, Terrain ownership, streaming groups and spawn/return anchors.
